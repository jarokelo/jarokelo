...
echo $this->render('@app/views/_snippets/_map', [
    'options' => [
        ...
        'center' => [
            'lat' => \app\models\db\Report::formatCoordinate(Yii::$app->params['map']['defaultPosition']['lat']),
            'lng' => \app\models\db\Report::formatCoordinate(Yii::$app->params['map']['defaultPosition']['lng']),
        ],
...
<div class="modal-content">
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title"><?= Yii::t('city', 'create') ?></h4>
    </div>
