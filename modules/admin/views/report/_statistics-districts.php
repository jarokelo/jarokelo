...
<div class="row block--grey">
    <?php $form = ActiveForm::begin([
        'id' => 'district-grid-view-search',
        'enableClientValidation' => false,
        'action' => ['report/statistics', 'tab' => \app\modules\admin\controllers\ReportController::TAB_DISTRICTS],
        'method' => 'get',
        'options' => [
            'data-pjax' => 1,
...
<?php Pjax::begin([
    'id' => 'district-search',
    'formSelector' => '#district-grid-view-search',
    'options' => [
        'data-pjax-target' => 'district-grid-view-search',
    ],
]) ?>
