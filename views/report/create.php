                ...
                <div class="col-xs-12 col-lg-8">
                    <div class="form__group form__asset">
                        ...
                        <div>
                            ...
                            <?= $form->field($model, 'report_category_id')->dropDownList(ReportCategory::getList(), ['prompt' => Yii::t('report', 'create.select_category')], ['class' => 'select select--default select--full step__final--hidden']) ?>
                ...
                <div class="col-xs-12 col-lg-4 step__help">
                    <div class="panel panel--info panel--title-offset panel--label-offset">
                        <div class="panel__body">
                            ...
                            <p><?= Yii::t('report', 'create.howtofill.subject'); ?></p>
